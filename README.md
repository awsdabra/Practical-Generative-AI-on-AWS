...
### Chapter 07: Using Open-source Frameworks with Amazon Bedrock
- **Example71-74.ipynb**: LangChain, LlamaIndex, and agent frameworks
- **data/**: Sample data for framework examples
- Focus: Framework integration, advanced orchestration
